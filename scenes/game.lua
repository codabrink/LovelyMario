...
function game:update(dt)
  ...
  if player[1]:getBody():getX() > (sWidth * .6) + screenX then
    screenX = player[1]:getBody():getX() - sWidth * .6
  elseif player[1]:getBody():getX() < (sWidth * .4) + screenX then
    screenX = player[1]:getBody():getX() - sWidth * .4
  end
